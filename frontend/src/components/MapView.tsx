...
import { Plus, Navigation, Menu, X, MapPin, Layers, Filter } from 'lucide-react';
...
export function MapView({ user, onReportClick, onLocationSelect, selectedLocation, isSidebarOpen, onSidebarToggle }: MapViewProps) {
  ...
  return (
    <div className="relative w-full h-full">
      {/* Map Container */}
      <div className="w-full h-full bg-linear-to-br from-blue-50 via-slate-50 to-green-50 relative overflow-hidden">
      ...
      {/* Menu Toggle Button - Mobile Only (Below Status Bar) */}
      <Button
      ...
      <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-2xl rounded-2xl shadow-lg shadow-gray-900/5 z-10 border border-gray-200/60 w-64 md:p-4 p-3 md:w-64 w-auto max-w-[90vw] overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="md:flex items-center justify-between md:mb-3.5 md:pb-3 md:border-b border-gray-200/60 hidden">
            ...
            <div className="w-9 h-9 rounded-xl bg-linear-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-md shadow-emerald-500/25">
          ...
          >
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-xl bg-linear-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-md shadow-emerald-500/20">
